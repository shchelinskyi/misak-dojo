            ...
            <div className={s.contentBlock}>
                <div className={cn(s.footerContent, s.order2)}>
                    <div className={cn(s.column, s.links)}>
                        <p className={s.textContent}>{t("design")}: <span className={s.link}>Посилання</span></p>
                        <p className={s.textContent}>{t("development")}: <span className={s.link}>Посилання</span></p>
                    </div>
                </div>
