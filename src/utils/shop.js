export const products = [
    {
        id: "1d30f8f2-8b69-11ee-b9d1-0242ac120002",
        title: {
    ...
    },
    {
        ...
        adult: false,
        description: {
            en: "You will be able to take personal belongings, a laptop, a tablet, and documents with you and place them inside the backpack as ergonomically as possible.\n" +
                "Outer material: durable waterproof polyester.\n" +
                "The main compartment, the neck of which is adjustable with a cord, is closed with a flap on fasteners.\n" +
                "3 pockets: a laptop compartment up to 15.6 inches inside, a large zippered patch pocket on the front, and another zippered pocket located on the flap of the backpack.\n" +
            ...
            ru: "Вы можете взять с собой личные вещи, ноутбук, планшет, документы и разместить их внутри рюкзака максимально эргономично.\n" +
                ...
                "3 кармана: отделение для ноутбука диагональю до 15.6 дюймов внутри, большой накладной карман на молнии спереди, и еще один карман на молнии расположен на клапане рюкзака.\n" +
    ...
    },
    {
        ...
        adult: false,
        description: {
            en: "The unique zipper of the main pocket tightens in the back, so the sling fits snugly against the pack and does not rattle when walking or running!\n" +
                "Anatomical soft handles are sewn with a special 3D Air Mesh, which will allow you to comfortably carry the backpack.\n" +
    ...
    {
        id: "ea927f2a-8b76-11ee-b9d1-0242ac120002",
        title: {
    ...
    {
        id: "6dc462dc-8b77-11ee-b9d1-0242ac120002",
        title: {
    ...
    {
        id: "50077404-8b78-11ee-b9d1-0242ac120002",
        title: {
