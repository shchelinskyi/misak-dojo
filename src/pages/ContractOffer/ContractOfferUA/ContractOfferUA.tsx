    ...
    return (
        <div className={s.container}>
            <div className={s.content}>
                ...
                <div className={s.textBlock}>
                    <p className={s.text}>
                        <b> Товар</b> — об'єкт матеріального світу, не вилучений з цивільного обороту і представлений до
                        продажу на
                ...
                <div className={s.textBlock}>
                    <p className={s.text}>
                        1.1. ГРОМАДСЬКА ОРГАНІЗАЦІЯ зобов'язується передати у власність БЛАГОДІЙНИКУ , а БЛАГОДІЙНИК
                        зобов'язується зробити добровільну благодійну пожертву і прийняти замовлений в інтернет-магазині
                        ТОВАР.
                    </p>
                    <p className={s.text}>
                ...
                <div className={s.textBlock}>
                    ...
                    <p className={s.text}>
                        ...
                        зобов'язання з приймання ТОВАРУ, а ГРОМАДСЬКА ОРГАНІЗАЦІЯ приймає зобов'язання з доставки та
                        ...
                        При відсутності ТОВАРУ на складі ГРОМАДСЬКОЇ ОРГАНІЗАЦІЇ остання зобов'язана проінформувати про
                        це БЛАГОДІЙНИКА в письмовій (за допомогою електронної пошти) або усній формі (за допомогою
                        телефонного зв'язку). В цьому випадку Благодійник має право замінити відсутній ТОВАР аналогічним
                        ТОВАРОМ.<br/><br/>
                ...
                <div className={s.textBlock}>
                    ...
                    <p className={s.text}>
                        ...
                        можливості повідомити про це Благодійника. При неможливості зв'язатися з Покупцем Замовлення
                ...
                <div className={s.textBlock}>
                    <p className={s.text}>
                        ...
                        ОРГАНІЗАЦІЯ зобов'язана надати БЛАГОДІЙНИКУ касовий або товарний чек, або інший документ, що
                    ...
                    <p className={s.text}>
                        4.4. При безготівковій формі благодійної грошової пожертви обов'язок благодійника щодо сплати
                ...
                <div className={s.textBlock}>
                    ...
                    <p className={s.text}>
                        5.5. ГРОМАДСЬКА ОРГАНІЗАЦІЯ зобов'язується докласти всіх можливих зусиль для здійснення доставки
                    ...
                    <p className={s.text}>
                        5.7. У разі зміни терміну поставки, ГРОМАДСЬКА ОРГАНІЗАЦІЯ зобов'язується негайно інформувати
                        БЛАГОДІЙНИКА про зміну умов поставки з метою отримання згоди на нові умови виконання Замовлення.
                        ГРОМАДСЬКА ОРГАНІЗАЦІЯ інформує БЛАГОДІЙНИКА за допомогою телефонного або електронного зв'язку.
                    </p>
                    <p className={s.text}>
                ...
                <div className={s.textBlock}>
                    <p className={s.text}>
                        ...
                        надзвичайні і непереборні за даних умов обставини, що перешкоджають виконанню своїх зобов'язань
                ...
                <div className={s.textBlock}>
                    <p className={s.text}>
                        ...
                        ім'я, по батькові покупця; адреса доставки; контактний телефон) з метою: - Виконання умов цього
